      ...
      <div className="min-h-screen bg-black text-white p-8">
        ...
        {isSuperAdmin && (
          <button
            ...
            className="mt-4 px-4 py-2 border border-teal-400 text-teal-400 text-xs tracking-widest uppercase hover:bg-teal-400 hover:text-black transition"
          >
            Admin Only
          </button>
        )}
